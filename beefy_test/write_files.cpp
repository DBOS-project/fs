...
/*
 * usage:
 * ./write_files <dir_id> <file_cnt> <block_size> <block_cnt> <total_blocks> <exec_time>
 */

int main (int argc, char **argv) {
    if (argc != 8) {
        printf("[Error] usage:\n./write_files <dir_id> <file_cnt> <block_size> <block_count> <total_blocks> <exec_time> <output suffix>b\n");
        return -1;
    }
    ...
    const int block_cnt = atoi(argv[4]);
